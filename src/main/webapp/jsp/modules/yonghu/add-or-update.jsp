                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="yonghuPhone" name="yonghuPhone" class="form-control"
                                               onchange="yonghuPhoneChickValue(this)"  placeholder="患者手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>患者身份证号</label>
                                        <input id="yonghuIdNumber" name="yonghuIdNumber" class="form-control"
                                               onchange="yonghuIdNumberChickValue(this)"  placeholder="患者身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>患者照片</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="yonghuAge" name="yonghuAge" class="form-control"
                                               onchange="yonghuAgeChickValue(this)"  placeholder="患者年龄">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jiashuPhone" name="jiashuPhone" class="form-control"
                                               onchange="jiashuPhoneChickValue(this)"  placeholder="家属联系方式">
                                    </div>
...
<script>
    ...
    //数字检查
        ...
        function jiashuPhoneChickValue(e){
            var this_val = e.value || 0;
            var reg=/^(13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8}$/;
            if(!reg.test(this_val)){
                e.value = "";
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                yonghuAge: "required",
                jiashuName: "required",
                jiashuPhone: "required",
            },
            messages: {
                yonghuName: "患者姓名不能为空",
                yonghuPhone: "患者手机号不能为空",
                yonghuIdNumber: "患者身份证号不能为空",
                yonghuPhoto: "患者照片不能为空",
                sexTypes: "性别不能为空",
                yonghuAge: "患者年龄不能为空",
                jiashuName: "家属姓名不能为空",
                jiashuPhone: "家属联系方式不能为空",
            }
        }).form();
    }
