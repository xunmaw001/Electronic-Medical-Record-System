    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">入院途径管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">入院途径管理</li>
                        <li class="breadcrumb-item active">入院途径列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">入院途径列表</h3>
...
<script>
    ...
    var tableName = "dictionaryRuyuantujing";
    var pageType = "list";
    var searchForm = {key: ""};
    var pageIndex = 1;
    var pageSize = 10;
    ...
    function getDataList() {
        http("dictionary/page", "GET", {
            ...
            order: sortOrder,
            //本表的
            dicCode: "ruyuantujing_types",//编码名字
            dicName: "入院途径名称",//汉字名字
