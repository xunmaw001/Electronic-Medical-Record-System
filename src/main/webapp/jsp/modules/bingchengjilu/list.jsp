        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">病程记录管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">病程记录列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">病程记录列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(jiashuPhoneCell);
                ...
                //病程详情
            var bingchengjiluContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.bingchengjiluContent && item.bingchengjiluContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.bingchengjiluContent.indexOf('<img');
                var endIndex = item.bingchengjiluContent.indexOf('>');
                    bingchengjiluContentCell.innerHTML = item.bingchengjiluContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.bingchengjiluContent != null && item.bingchengjiluContent != "" && item.bingchengjiluContent.length >= 11) {
                        bingchengjiluContentCell.innerHTML = item.bingchengjiluContent.substring(0, 10) + "...";
                } else {
                        bingchengjiluContentCell.innerHTML = item.bingchengjiluContent;
                }
            }
            row.appendChild(bingchengjiluContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("bingchengjilu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addbingchengjilu", "addbingchengjilu");
            window.location.href = "add-or-update.jsp"
        }
