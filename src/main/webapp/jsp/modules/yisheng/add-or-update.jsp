...
<script>
    ...
    function readonly() {
        ...
        }else if (window.sessionStorage.getItem('role') == '门诊医生' || window.sessionStorage.getItem('role') == '住院医生') {
            $(".aaaaaa").remove();
            $('#roleTypesSelect').attr('readonly', 'readonly');
            $('#roleTypesSelect').attr('style', 'pointer-events: none;');
            $('#keshiTypesSelect').attr('readonly', 'readonly');
            $('#keshiTypesSelect').attr('style', 'pointer-events: none;');
