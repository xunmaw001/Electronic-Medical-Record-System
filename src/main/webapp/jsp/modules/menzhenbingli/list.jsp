                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">门诊病历列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(zhenduanContentCell);
                ...
                //处方详情
            var chufangContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.chufangContent && item.chufangContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.chufangContent.indexOf('<img');
                var endIndex = item.chufangContent.indexOf('>');
                    chufangContentCell.innerHTML = item.chufangContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.chufangContent != null && item.chufangContent != "" && item.chufangContent.length >= 11) {
                        chufangContentCell.innerHTML = item.chufangContent.substring(0, 10) + "...";
                } else {
                        chufangContentCell.innerHTML = item.chufangContent;
                }
            }
            row.appendChild(chufangContentCell);
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addmenzhenbingli", "addmenzhenbingli");
            window.location.href = "add-or-update.jsp"
        }
