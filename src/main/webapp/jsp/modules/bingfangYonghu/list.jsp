        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">病房患者管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">病房患者列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">病房患者列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(roomCell);
                        ...
                        //是否被使用
            var bingfangTypesCell = document.createElement('td');
            bingfangTypesCell.innerHTML = item.bingfangValue;
            row.appendChild(bingfangTypesCell);
            ...
            //住院时间
            var zhuyuanTimeCell = document.createElement('td');
            zhuyuanTimeCell.innerHTML = item.zhuyuanTime;
            row.appendChild(zhuyuanTimeCell);


            //出院时间
            var chuyuanTimeCell = document.createElement('td');
            chuyuanTimeCell.innerHTML = item.chuyuanTime;
            row.appendChild(chuyuanTimeCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("bingfangYonghu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addbingfangYonghu", "addbingfangYonghu");
            window.location.href = "add-or-update.jsp"
        }
