...
public class BingchengjiluView extends BingchengjiluEntity implements Serializable {
	...
	public BingchengjiluView() {

	}

	public BingchengjiluView(BingchengjiluEntity bingchengjiluEntity) {
		try {
			BeanUtils.copyProperties(this, bingchengjiluEntity);
