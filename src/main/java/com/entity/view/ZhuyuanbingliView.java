...
public class ZhuyuanbingliView extends ZhuyuanbingliEntity implements Serializable {
	...
	public ZhuyuanbingliView() {

	}

	public ZhuyuanbingliView(ZhuyuanbingliEntity zhuyuanbingliEntity) {
		try {
			BeanUtils.copyProperties(this, zhuyuanbingliEntity);
